...
r = agents.run_query("Is it safe to fish near Kochi tomorrow?")
...
r = agents.run_query("Which coastal areas near Chennai need increased monitoring?")
...
r = agents.run_query("Which coastal areas require immediate preparedness near Visakhapatnam?")
...
with patch.object(agents, "fetch_live_wind", return_value=severe_wind), \
     patch.object(agents, "fetch_live_marine", return_value=severe_marine):
    ...
    r = agents.run_query("Should I go to sea near Chennai today?")
...
r = agents.run_query("क्या कल कोच्चि के पास मछली पकड़ना सुरक्षित है?")
...
r = agents.run_query("उद्या चेन्नईजवळ मासेमारी करणे सुरक्षित आहे का?")
